...
public class PhoneCallsPermissionsFragment extends Fragment implements CompoundButton.OnCheckedChangeListener, OnPermissionExplanationListener {
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		if (isChecked) {
//			buttonView = findViewById(R.id.switchPhoneStatePermission);

			if (buttonView.getId() == R.id.switchPhoneStatePermission) {
				requestPhoneStatePermission();
			} else if (buttonView.getId() == R.id.switchReadCallLogPermission) {
				requestReadCallLogPermission();
			} else if (buttonView.getId() == R.id.switchReadContactsPermission) {
