...
import com.mansourappdevelopment.androidapp.kidsafe.fragments.WebFragment;
...
//				Fragment selectedFragment = null;
				...
				if (menuItemId == R.id.nav_apps) {
					selectedFragment = new AppsFragment();
				} else if (menuItemId == R.id.navWeb) {
					selectedFragment = new WebFragment();
				} else if (menuItemId == R.id.navLocation) {
					selectedFragment = new LocationFragment();
				} else if (menuItemId == R.id.navActivityLog) {
