...
public class SettingsPermissionsFragment extends Fragment implements CompoundButton.OnCheckedChangeListener {
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		if (isChecked) {
			if (buttonView.getId() == R.id.switchWriteSettingsPermission) {
				requestWriteSettingsPermission();
			} else if (buttonView.getId() == R.id.switchOverlayPermission) {
				requestOverlayPermission();
			} else if (buttonView.getId() == R.id.switchPackageUsagePermission) {
				requestPackageUsagePermission();
			} else if (buttonView.getId() == R.id.switchDeviceAdminPermission) {
