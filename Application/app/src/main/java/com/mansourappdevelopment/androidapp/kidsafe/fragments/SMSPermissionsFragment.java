...
public class SMSPermissionsFragment extends Fragment implements CompoundButton.OnCheckedChangeListener, OnPermissionExplanationListener {
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		if (isChecked) {if (buttonView.getId() == R.id.switchSendSmsPermission) {
			requestSendSmsPermission();
		} else if (buttonView.getId() == R.id.switchReadSmsPermission) {
			requestReadSmsPermission();
		} else if (buttonView.getId() == R.id.switchReceiveSmsPermission) {
